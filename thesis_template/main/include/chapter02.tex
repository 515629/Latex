...
\subsection{機体諸元}
開発した機体の主要諸元をTable \ref{tab:specs_detail}に示す．
\begin{table}[H]
  \centering
  \caption{Detailed specifications of the robot}
  \label{tab:specs_detail}
  \begin{tabular}{|l|l|}
    \hline
    項目 & 内容・数値 \\ \hline \hline
    外形寸法 & L500 $\times$ W400 $\times$ H250 [mm] \\ \hline
    機体総重量 & 約 15.0 [kg] \\ \hline
    吸着磁石 & ネオジム磁石 (N52) $\times$ 20 個 \\ \hline
    壁面ギャップ & 5.0 [mm] \\ \hline
    駆動モータ & DCギヤードモータ \\ \hline
    制御方式 & 2.4GHz 無線通信 (DualShock 4) \\ \hline
  \end{tabular}
\end{table}
